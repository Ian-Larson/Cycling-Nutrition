  ...
  return (
    <button
      className={clsx(
        ...
        {
          'border-brand-500 bg-brand-500 text-ink-900 shadow-[0_12px_26px_-16px_rgba(248,98,46,0.74)] hover:border-brand-700 hover:bg-brand-700 hover:text-white hover:shadow-[0_16px_32px_-18px_rgba(248,98,46,0.82)]': variant === 'primary',
