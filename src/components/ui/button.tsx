  ...
  return (
    <button
      className={clsx(
        ...
        {
          'border-brand-600 bg-brand-600 text-white shadow-[0_10px_22px_-16px_rgba(84,117,151,0.7)] hover:bg-brand-700 hover:shadow-[0_14px_28px_-18px_rgba(84,117,151,0.78)]': variant === 'primary',
