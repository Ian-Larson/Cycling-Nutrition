  ...
  return (
    <button
      className={clsx(
        ...
        {
          'border-brand-500 bg-brand-500 text-white shadow-[var(--shadow-brand-glow-md)] hover:border-brand-700 hover:bg-brand-700 hover:shadow-[var(--shadow-brand-glow-lg)]': variant === 'primary',
